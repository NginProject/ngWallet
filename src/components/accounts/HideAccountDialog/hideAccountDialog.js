        ...
        <div style={{width: '100%'}}>
          ...
          <div style={{marginRight: '20px'}}>
            <Warning>
              ...
              <WarningText>This will only hide the account. If you really need to delete an account on disk, you can use ngWallet-CLI, or manually delete the account key files from the computer's file system.</WarningText>
            </Warning>
          </div>
          <Button
            style={{
