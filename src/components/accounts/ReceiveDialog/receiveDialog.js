  ...
  return (
    <Dialog
      ...
      <div className={ classes.container }>
        <div>
          <div className={ classes.title }>Add NG</div>
        ...
        <div>
          ...
          <div style={{marginTop: '30px', marginLeft: '30px'}}>
            <div className={ classes.headerText }>Top up your account with NG</div>
            <div>
              <AccountAddress id={ address } style={ styles.address }/>
            </div>
            <div className={ classes.note }>
              Share your account address and use it to top up your account with NG from any other service.
